...
document.body.innerHTML += `Qual o primeiro índice da letra ${nome[7]} no seu nome? ${nome.indexOf('A')}<br/>`
document.body.innerHTML += `Qual o último índice da letra ${nome[7]} no seu nome? ${nome.lastIndexOf('a')}<br/>`
